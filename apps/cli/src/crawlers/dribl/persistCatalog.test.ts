import { ok, type MappedTableEntry } from "@matchday/domain";
...
import type { CrawlCatalogLeagueResult } from "./crawlCatalog.ts";
import { persistCatalog } from "./persistCatalog.ts";
