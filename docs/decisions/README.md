...
| 0012 | [Subscriptions & multi-source](0012-subscription-multisource.md)           | superseded | Subscribe a client to a league; split catalog from deep crawl; many sources — scope replaced by 0016 |
...
| 0016 | [Crawl scope](0016-crawl-scope.md)                                         | decided    | Crawl scope is a system table of targets, not per-client subscriptions                               |
