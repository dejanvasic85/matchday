 ...
 * never a raw pg TCP connection from a Worker. Injected as a dependency: services
 * and jobs receive the returned client by argument so tests can pass a fake.
 *
 * neon-http supports single-shot and batched queries, not interactive transactions.
 */
